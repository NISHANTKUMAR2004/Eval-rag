...
down_revision = 'a5c4fa570a7d'
branch_labels = None
depends_on = None


def upgrade() -> None:
    # Create chat_message_role enum type safely
    try:
    ...
    op.create_table(
        ...
        sa.Column('project_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('role', postgresql.ENUM('user', 'assistant', name='chat_message_role', create_type=False), nullable=False),
