...
export default function RegisterPage() {
  ...
  const [fullName, setFullName] = useState("Nishant Babu");
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 px-4 text-slate-100">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 h-96 w-96 rounded-full bg-indigo-600/10 blur-[128px] animate-pulse-glow"></div>
        <div className="absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-violet-600/10 blur-[128px] animate-pulse-glow" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="mt-4 text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-100 to-slate-400">
            Join <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-indigo-400">EvalGuard AI</span>
          </h1>
          <p className="mt-2 text-sm text-slate-400">
            Build, test, and evaluate RAG pipelines with confidence.
          </p>
        </div>
        ...
        <div className="glass-panel w-full rounded-3xl p-8 shadow-2xl shadow-black/50 border border-slate-800/80">
          ...
          <p className="mt-1 text-xs text-slate-500">Sign up and configure your system profile.</p>
          ...
          <div className="mt-6 border-t border-slate-800/80 pt-6 text-center">
            <p className="text-sm text-slate-400">
              ...
              <Link className="font-semibold text-violet-400 hover:text-violet-300 transition-colors" to="/login">
                Login here
              </Link>
            </p>
          </div>
